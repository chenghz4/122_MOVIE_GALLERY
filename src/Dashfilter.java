 ...
 */
@WebFilter(filterName = "DashFilter", urlPatterns = "/dashboard.html")
public class Dashfilter implements Filter {
    ...
    private boolean isUrlAllowedWithoutLogin(String requestURI) {
        ...
        return requestURI.endsWith("dashboard_login.html") || requestURI.endsWith("dashboard_login.js")
                || requestURI.endsWith("api/dash_login");
    }
